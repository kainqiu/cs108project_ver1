...
for(int i = 0; i < histories.size(); i++) {
	...
	out.println("<p class='each_history'>Took quiz <a href='QSummary.jsp?id=" + h.getQuizId() + "'>" + Quiz.getTitleById(h.getQuizId(), con) + "</a>, using " + h.getElapsedTime() + " seconds, score is " + h.getScore() + ", at " + h.getFinishAt() + ". </p>");
}
%>
