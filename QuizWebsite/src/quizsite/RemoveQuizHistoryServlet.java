...
/**
 * Servlet implementation class RemoveQuizHistoryServlet
 */
...
public class RemoveQuizHistoryServlet extends HttpServlet {
     ...
     */
    public RemoveQuizHistoryServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int quizIdToRemove = Integer.parseInt(request.getParameter("quizIdToRemove"));
		if(Admin.removeQuizHistory(quizIdToRemove, con)) {
